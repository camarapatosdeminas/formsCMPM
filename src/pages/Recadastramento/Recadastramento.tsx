    ...
    <div className="recadastramento-shell">
      ...
      <div className="annex-map" aria-label="Anexos que serão gerados">
        ...
        <div>
          ...
          <span>
            A íntegra da Portaria, os textos legais, títulos, órgão e
            declarações já estão definidos no código.
          </span>
        </div>
        <div>
      ...
      <form onSubmit={(event) => event.preventDefault()} noValidate>
        <section className="rec-section rec-section-highlight">
          <div className="section-heading">
            ...
            <div>
              ...
              <p>
                Essa escolha determina quais anexos entram no arquivo final.
              </p>
            </div>
          </div>
          ...
          <div className="choice-grid">
            <label
              className={`choice-card ${data.tipoRecadastramento === "completo" ? "is-selected" : ""}`}
            >
              <input
                type="radio"
              ...
              <span>
                ...
                <small>
                  Para quem teve alterações ou precisa atualizar todo o
                  cadastro.
                </small>
              </span>
            </label>
            <label
              className={`choice-card ${data.tipoRecadastramento === "simplificado" ? "is-selected" : ""}`}
            >
              <input
                type="radio"
                name="tipoRecadastramento"
              ...
              <span>
                ...
                <small>
                  Somente quando não houve alteração desde o último
                  recadastramento.
                </small>
              </span>
            </label>
          ...
          <div className="choice-grid choice-grid-compact">
            <label
              className={`choice-card ${data.tipoPessoa === "servidor" ? "is-selected" : ""}`}
            >
              <input
                type="radio"
                name="tipoPessoa"
            ...
            <label
              className={`choice-card ${data.tipoPessoa === "vereador" ? "is-selected" : ""}`}
            >
              <input
                type="radio"
                name="tipoPessoa"
        ...
        <section className="rec-section" id="identificacao">
          ...
          <div className="rec-grid rec-grid-3">
            ...
            <label className="field">
              ...
              <input
                className={inputClass("cargoFuncao")}
            ...
            <label className="field">
              ...
              <input
                type="date"
                className={inputClass("dataDeclaracao")}
          ...
          <>
            <section className="rec-section">
              <div className="section-heading">
                ...
                <div>
                  <h3>Anexo I - Dados pessoais e documentos</h3>
                  <p>
                    Campos sem asterisco podem ser deixados em branco quando não
                    se aplicarem.
                  </p>
                </div>
              </div>
              <div className="rec-grid rec-grid-4">
                ...
                <label className="field field-span-2">
                  ...
                  <input
                    className={inputClass("naturalidade")}
                ...
                <label className="field">
                  ...
                  <input
                    maxLength={2}
                    className={inputClass("ufNascimento")}
                ...
                <label className="field field-checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      update("possuiDeficiencia", e.target.checked)
                    }
                  />
                ...
                {data.possuiDeficiencia && (
                  <label className="field field-span-4">
                    ...
                    <input
                      className={inputClass("tipoDeficiencia")}
                      value={data.tipoDeficiencia}
                      onChange={(e) =>
                        update("tipoDeficiencia", e.target.value)
                      }
                    />
                  </label>
                )}
              ...
              <div className="rec-grid rec-grid-4">
                ...
                <label className="field">
                  ...
                  <input
                    ...
                    value={data.rgUf}
                    onChange={(e) =>
                      update("rgUf", e.target.value.toUpperCase())
                    }
                  />
                </label>
                <label className="field">
                ...
                <label className="field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      update("eleitorUf", e.target.value.toUpperCase())
                    }
                  />
                </label>
                <label className="field">
                ...
                <label className="field">
                  ...
                  <input
                    ...
                    value={data.ctpsUf}
                    onChange={(e) =>
                      update("ctpsUf", e.target.value.toUpperCase())
                    }
                  />
                </label>
                <label className="field">
            ...
            <section className="rec-section">
              <div className="section-heading">
                ...
                <div>
                  <h3>Anexo I - Endereço e contato</h3>
                  <p>
                    O endereço também será inserido nas declarações de bens e de
                    não acumulação.
                  </p>
                </div>
              </div>
              <div className="rec-grid rec-grid-4">
                ...
                <label className="field">
                  ...
                  <input
                    maxLength={2}
                    className={inputClass("enderecoUf")}
                    value={data.enderecoUf}
                    onChange={(e) =>
                      update("enderecoUf", e.target.value.toUpperCase())
                    }
                  />
                </label>
                <label className="field">
                ...
                <label className="field">
                  ...
                  <input
                    ...
                    value={data.celular}
                    onChange={(e) =>
                      update("celular", maskPhone(e.target.value))
                    }
                    inputMode="tel"
                  />
                </label>
            ...
            <section className="rec-section">
              <div className="section-heading">
                ...
                <div>
                  <h3>Anexo I - Dados funcionais</h3>
                  <p>
                    Informações profissionais e bancárias do cadastro funcional.
                  </p>
                </div>
              </div>
              <div className="rec-grid rec-grid-3">
              ...
              {data.exerceAtividadeRemunerada && (
                <label className="field field-textarea">
                  ...
                  <textarea
                    className={inputClass("atividadeRemuneradaDetalhes")}
            ...
            <section className="rec-section">
              <div className="section-heading">
                ...
                <div>
                  <h3>Anexo II - Declaração de bens</h3>
                  <p>
                    Adicione quantos bens forem necessários. Textos extensos
                    continuarão automaticamente na página seguinte do PDF.
                  </p>
                </div>
              </div>
              <div className="repeat-list">
                {data.bens.map((bem, index) => (
                  <div
                    className={`repeat-card ${inputClass(`bem-${bem.id}`)}`}
                    key={bem.id}
                  >
                    ...
                    <div className="rec-grid rec-grid-assets">
                      ...
                      <label className="field">
                        ...
                        <input
                          value={bem.valor}
                          onChange={(e) =>
                            updateBem(bem.id, "valor", e.target.value)
                          }
                          inputMode="decimal"
                          placeholder="0,00"
                        />
            ...
            {data.tipoPessoa === "vereador" && (
              <section className="rec-section">
                <div className="section-heading">
                  ...
                  <div>
                    <h3>Anexo IV - Situação do vereador</h3>
                    <p>
                      Selecione a declaração compatível com sua situação
                      funcional.
                    </p>
                  </div>
                </div>
                <div className="stacked-options">
                  <label>
                    ...
                    />
                    <span>
                      Não sou servidor público em exercício de mandato eletivo.
                    </span>
                  </label>
                  <label>
                    <input
                      ...
                      onChange={() =>
                        update("situacaoVereador", "servidorCompativel")
                      }
                    />
                    <span>
                      Sou servidor público e há compatibilidade de horários.
                    </span>
                  </label>
                  <label>
                    <input
                      ...
                      onChange={() =>
                        update("situacaoVereador", "servidorIncompativel")
                      }
                    />
                    <span>
                      Sou servidor público e há incompatibilidade de horários.
                    </span>
                  </label>
                </div>
                {data.situacaoVereador === "servidorIncompativel" && (
                  <div className="conditional-box">
                    ...
                    {data.opcaoRemuneracao === "naoOpta" && (
                      <>
                        <strong>
                          Base das contribuições ao regime próprio
                        </strong>
                        <label>
                          <input
                            type="radio"
                            ...
                            checked={
                              data.baseContribuicao === "subsidioVereador"
                            }
                            onChange={() =>
            ...
            <section className="rec-section">
              <div className="section-heading">
                ...
                <div>
                  <h3>Anexo VI - Dependentes</h3>
                  <p>
                    Deixe a lista vazia se não houver dependentes. IR = Imposto
                    de Renda; AF = Abono Família; AM = Assistência Médica e
                    Odontológica.
                  </p>
                </div>
              </div>
              {data.dependentes.length === 0 && (
                <div className="empty-state">Nenhum dependente incluído.</div>
              )}
              <div className="repeat-list">
                {data.dependentes.map((dependente, index) => (
                  <div
                    className={`repeat-card ${inputClass(`dependente-${dependente.id}`)}`}
                    key={dependente.id}
                  >
                    <div className="repeat-card-header">
        ...
        <section className="download-panel">
          <div>
            ...
            <p>
              O botão de download só aparece depois que os campos obrigatórios e
              condicionais forem validados.
            </p>
          </div>
          <button type="button" className="primary-button" onClick={preparePdf}>
            Validar e preparar PDF
          </button>
          ...
          {ready && (
            <div className="download-ready" aria-live="polite">
              <div>
                ...
                <span>Seu PDF está pronto para ser montado e baixado.</span>
              </div>
              <PDFDownloadLink
              ...
              >
                {({ loading }) =>
                  loading ? "Montando PDF..." : "Baixar PDF completo"
                }
              </PDFDownloadLink>
            </div>
          )}
